...
(function (AutoFixtureTSUnitTest) {
    describe("AutoFixtureTS.RangedNumberGeneratorTests", function () {
        it("CreateAnonymous with positive numbers gives Correct Result", function () {
        ...
        it("CreateAnonymous with negative numbers gives Correct Result", function () {
